...
/* --- Class --- */
public class SenseIMUActivity extends AppCompatActivity implements ESenseSensorListener,ESenseConnectionListener, ESenseEventListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mGyro != null) {
            sensorManager.registerListener((SensorEventListener) SenseIMUActivity.this, mGyro, SensorManager.SENSOR_DELAY_NORMAL);
    ...
    public void beginTracking(View view) {
        ...
        if (isConnected) {
            ...
            manager = new ESenseManager(devicename,
                    SenseIMUActivity.this.getApplicationContext(), this);
    ...
    private void writeToFile() {
        ...
        if(!writeQueue_gyro.isEmpty()) {
            ...
            //Buffer the data for writing to a CSV
            dex.directWriteToFile_gyro(toWrite_gyro);
...
//                    Short.toString(gyro[2]);
    ...
    private void register(){
        ...
        sensorManager.registerListener(SenseIMUActivity.this, accel, SensorManager.SENSOR_DELAY_GAME);
    }

    private void unregister(){
        if (sensorManager != null) {
            sensorManager.unregisterListener(SenseIMUActivity.this);
        }
    }
