...
/**
 * This service will keep sending all the message to the watch
 */
public class SendWatchMessageIntentService extends IntentService implements GoogleApiClient.ConnectionCallbacks {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (Node node : nodes.getNodes()) {
            ...
            mApiClient, node.getId(), PHONE_TO_WATCH_MESSAGE_PATH, intent.getStringExtra(INPUT_EXTRA).getBytes()).await();
        }
    }
